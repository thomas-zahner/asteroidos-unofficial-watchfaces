...
Item {
    ...
    Canvas {
        ...
        onPaint: {
            ...
            ctx.lineWidth = parent.height*0.011
            ctx.beginPath()
            ctx.moveTo(parent.width/2, parent.height/2)
            ctx.lineTo(parent.width/2+Math.cos((second - 45)/60 * 2 * Math.PI)*width*0.13,
                       parent.height/2+Math.sin((second - 45)/60 * 2 * Math.PI)*width*0.13)
            ctx.stroke()
            ctx.closePath()
            ctx.beginPath()

            ctx.moveTo(parent.width/2, parent.height/2)
            ctx.lineTo(parent.width/2+Math.cos((second - 15)/60 * 2 * Math.PI)*width*0.21,
                       parent.height/2+Math.sin((second - 15)/60 * 2 * Math.PI)*width*0.21)
            ctx.stroke()
            ctx.closePath()
            ...
            ctx.arc(parent.width/2+Math.cos((second - 15)/60 * 2 * Math.PI)*width*0.23,
                    parent.height/2+Math.sin((second - 15)/60 * 2 * Math.PI)*width*0.23,
                    parent.height*0.02, 0, 2*Math.PI, false)
            ctx.fill()
            ctx.stroke()
            ctx.closePath()
        }
